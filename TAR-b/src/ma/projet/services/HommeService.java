...
public List<Mariage> mariagesHommeAvecDetails(Homme homme) {
...
public static void getEpousesParHomme(Homme homme) {
 ...
 public void marriedByFourWomenBetweenDates(Date startDate, Date endDate) {
        Session session = HibernateUtil.getSessionFactory().openSession();
...
public List<Mariage> mariagesByHomme(Homme homme) {
        Session session = HibernateUtil.getSessionFactory().openSession();
