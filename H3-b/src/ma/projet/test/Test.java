...
public class Test {
  public static void main(String[] args) {
       ...
       //creation des employes
        Employe e1 = new Employe("EL GARDA", "EL GARDA", "00000000");
        Employe e2 = new Employe("BASMA", "BASMA", "0999999");
        Employe e3 = new Employe("NASMA", "NASMA", "0777777");
        es.create(e2);
        es.create(e1);
        es.create(e3);
        //creation des projets 
        Projet p1 = new Projet("JAVA",new Date("2020/01/01"), new Date("2020/05/30"), e2);
        Projet p2 = new Projet("JEE",new Date("2021/01/01"), new Date("2021/05/30"), e2);
        ps.create(p1);
        ps.create(p2);
        //creation taches
        Tache t1 = new Tache("COMPILATION", new Date("2020/01/01"), new Date("2020/05/30"),20222 , p1);
        Tache t2 = new Tache("RUN", new Date("2021/01/01"), new Date("2021/05/30"),10111 , p2);
        ts.create(t1);
        ts.create(t2);
       ...
       // e2.getProjets().add(p);
        ...
        // Attribution des tâches à "EL GARDA"
        ...
        System.out.println("Tâches assignées à 'BASMA'.");
        es.getTachesparEmployee(e2);
        es.getProjetparEmployee(e2);
        System.out.println(p2.getId());
        ps.getTachesparProjets(p2);
        System.out.println("Projts assignées à 'BASMA'.");
